  ...
  return (
    <section id="contact" className="py-24 px-6 lg:px-8 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/3 left-1/3 w-72 h-72 bg-green-500/4 rounded-full blur-3xl" />
      </div>
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        >
          <p className="text-green-400 font-mono text-sm tracking-widest uppercase mb-3">Say hello</p>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="p-2.5 rounded-xl bg-green-500/10 text-green-400 group-hover:bg-green-500/20 transition-colors shrink-0">
                ...
                <span className="text-gray-500 text-sm font-mono group-hover:text-green-400 transition-colors">
                  {c.value}
                </span>
              </motion.a>
            );
