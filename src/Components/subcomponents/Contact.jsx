  ...
  return (
    <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/3 left-1/3 w-48 h-48 sm:w-72 sm:h-72 bg-cyan-500/4 rounded-full blur-3xl" />
      </div>
      ...
      <div className="max-w-2xl mx-auto relative z-10">
        ...
        >
          <p className="text-cyan-400 font-mono text-xs sm:text-sm tracking-widest uppercase mb-3">Say hello</p>
          ...
          {contacts.map((c, i) => {
            ...
            return (
              <motion.a
                ...
                variants={item}
                whileHover={{ x: 4 }}
                className="flex items-center justify-between p-4 sm:p-5 glass-card group cursor-pointer"
              >
                <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                  <div className="p-2 sm:p-2.5 rounded-xl bg-cyan-500/10 text-cyan-400 group-hover:bg-cyan-500/20 transition-colors shrink-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-gray-500 text-xs mt-0.5 hidden sm:block">{c.description}</p>
                  </div>
                </div>
                <span className="text-gray-500 text-xs sm:text-sm font-mono group-hover:text-cyan-400 transition-colors truncate max-w-[120px] sm:max-w-none ml-2 text-right">
                  {c.value}
                </span>
              </motion.a>
            );
