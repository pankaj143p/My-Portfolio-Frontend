  ...
  return (
    <section id="skills" className="py-24 px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
                ...
                {cat.skills.map((skill, si) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="flex flex-col items-center gap-2 p-3 rounded-xl bg-white/3 hover:bg-purple-500/8 border border-transparent hover:border-purple-500/20 transition-all duration-200 cursor-default group"
                    >
                      <Icon
        ...
        >
          <p className="text-gray-500 text-sm mb-4 font-mono">Currently exploring →</p>
          <div className="flex flex-wrap justify-center gap-2">
            {["Machine Learning", "AI Integration", "GraphQL", "Microservices", "DevOps", "Cloud Computing", "Next.js 14"].map((t) => (
