  ...
  return (
    <section id="github" className="py-20 px-6 lg:px-8 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-40 bg-green-500/4 rounded-full blur-3xl" />
      </div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <p className="text-green-400 font-mono text-sm tracking-widest uppercase mb-3">Activity</p>
